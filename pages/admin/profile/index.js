...
import { opadminUpdatePassword } from '../../../src/utils/fetchApi/auth';
...
export default function AccountAdmin() {
  ...
  useEffect(() => {
    ...
    const { Email: email, OperationalAdmin: opadmin } = jwtDecode();
  ...
  const handleUpdatePassword = async (e) => {
    e.preventDefault();
    const res = await opadminUpdatePassword(setLoading, setAlertProfile, {
